              ...
              fluidRow(
                column(6,
                       ...
                       dateRangeInput(inputId = "CodFH_seas1", label = "For Hire Season 1",
                                      ...
                                      min   = as.Date("2026-05-01"),
                                      max   = as.Date("2027-04-30"),
                                      format = "yyyy-mm-dd"),
                       fluidRow(
                         column(4,
                       ...
                       dateRangeInput(inputId = "CodFH_seas2", label ="For Hire Season 2",
                                      start = as.Date("2026-09-01"),
                                      end   = as.Date("2026-10-31"),
                                      min   = as.Date("2026-05-01"),
                                      max   = as.Date("2027-04-30"),
                                      format = "yyyy-mm-dd"),
                       fluidRow(
                       ...
                       shinyjs::hidden( div(ID = "CodSeason3",
                                            dateRangeInput(inputId = "CodFH_seas3", label ="For Hire Season 3",
                                            ...
                                            dateRangeInput(inputId = "CodPR_seas3", label ="Private Season 3",
                                                           start = as.Date("2027-01-01"),
                                                           end   = as.Date("2027-01-01"),
                                                           min   = as.Date("2026-05-01"),
                                                           max   = as.Date("2027-04-30"),
                ...
                column(6,
                       ...
                       shinyjs::hidden( div(ID = "HadSeason3",
                                            dateRangeInput(inputId = "HadFH_seas3", label ="For Hire Season 3",
                                                           start = as.Date("2027-03-01"),
                                                           end   = as.Date("2027-03-01"),
                                                           min   = as.Date("2026-05-01"),
                                                           max   = as.Date("2027-04-30"),
                                                           format = "yyyy-mm-dd"),
                                            fluidRow(
